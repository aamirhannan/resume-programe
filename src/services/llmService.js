...
`;
    ...
    /**
     * Parses raw resume text into a structured JSON profile using the LLM.
     * @param {string} resumeText - The raw text extracted from the resume PDF.
     * @param {object} tokenUsage - Optional tracker for token usage.
     * @returns {Promise<object>} - The structured job profile object.
     */
    async parseResumeToProfile(resumeText, tokenUsage = null) {
